...
const ArticleCard = ({ title, image }) => (
    <div className='relative overflow-hidden rounded-lg group'>
        <Image
            ...
            width={600}
            height={350}
            className='w-full h-[350px] object-cover transition-transform duration-700 group-hover:scale-110 group-hover:brightness-75'
        />
        <div className='absolute inset-0 flex flex-col justify-between p-8'>
            <div className='cursor-pointer bg-white outline-white outline-1 group-hover:bg-transparent group-hover:outline group-hover:text-white text-black text-xs font-semibold py-1 px-2 rounded w-fit'>
                RESTAURANT
            </div>

...
function SectionHeader({ sub, main }) {
    return (
        <div className='flex flex-col items-center'>
            ...
            <h1
                className={`text-4xl font-normal text-center ${pangaiaBold.className}`}
            >
                {main}
            </h1>
        </div>
        ...
        >
            <Link href={dish.href}>
                <div className='bg-gradient-to-t from-white to-[#F4EFE3] rounded-3xl flex flex-col items-center justify-center gap-1.5 h-full py-4 px-2'>
                    ...
                    <div className='w-8 h-0.5 bg-golden my-2'></div>
                    <h2
                    ...
                    <p className='text-light-golden font-semibold text-xs'>
                        {dish.qty} PRODUCTS
                    </p>
                </div>
            </Link>
...
export default function ImprovedDishCarousel() {
    return (
        <div className='feather-shadow flex flex-col items-center gap-8 px-4 sm:px-6 md:px-8 lg:px-12 w-full'>
